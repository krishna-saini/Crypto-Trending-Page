...
function PairCoin(props:PairCoinsProps){
    ...
    return(
      ...
      <p className="font-tomorrow flex h-[40px] w-[242px] items-center justify-center rounded-[17px] border-[1px] bg-[#14172B] pl-16 font-[600]">{popularPairs.map((el,i)=>( <img key={i} src={el.icon}/>))}</p>
